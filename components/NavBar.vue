<template>
  <header
    class="sticky top-0 z-40 bg-background/80 backdrop-blur-lg border-b border-border"
  >
    <div class="container flex h-16 items-center">
      ...
      <div class="hidden pl-24 lg:flex flex-1 items-center justify-end">
        <ThemeToggle />
        <Button
          as-child
          size="icon"
...
import { Package, Menu } from "lucide-vue-next";

const routeList = useLandingRoutes();
</script>
